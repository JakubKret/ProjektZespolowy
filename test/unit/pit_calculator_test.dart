...
import 'package:krwiodawstwo/core/database/daos/pit_annual_summary_dao.dart';
...
void main() {
  ...
  group('recalculateYear', () {
    test('calculates annual PIT summary using accepted donations only',
        () async {
    ...
    test('updates existing year summary instead of inserting duplicate',
        () async {
      final donorId = await insertDonor();
      final bloodCenterId = await insertBloodCenter();
